              ...
              children: [
                CircleAvatar(
                  backgroundImage: AssetImage(
                    "assets/images/cartoon/ameer.png",
                  ),
                  radius: 80,
                ),
                SizedBox(
                  ...
                  child: ListView(
                    children: [
                      Card(
                        color: appColor,
                        child: ListTile(
                          leading: Icon(Icons.person,color: appColorDark,),
                          title: Text("My Account",style: TextStyle(
                            fontWeight: FontWeight.bold,color: appColorDark,
                          ),),
                        ),
                      ),
                      SizedBox(
                      ...
                      Card(
                        color: appColor,
                        child: ListTile(
                          leading: Icon(Icons.dashboard,color: appColorDark,),
                      ...
                      Card(
                        color: appColor,
                        child: ListTile(
                          leading: Icon(Icons.info,color: appColorDark,),
                          title: Text(
                            "About",
                            style: TextStyle(
                              fontWeight: FontWeight.bold,color: appColorDark
                      ...
                      Card(
                        color: appColor,
                        child: ListTile(
                          leading: Icon(Icons.logout,color: appColorDark,),
                          title: Text(
                              "Logout",
                          style: TextStyle(fontWeight: FontWeight.bold,color: appColorDark),
                          ),
                        ),
                      ),
                    ],
